...
def preprocess_audio(audio):
    ...
    # pad 0.2 sec silence to avoid last-word cutoff
...
def decode_prediction(pred):
    ...
    # integer sequence lengths (important!)
    input_len = np.full((pred.shape[0],), pred.shape[1], dtype=np.int32)
...
# STREAMLIT UI
# =============================
st.title("Code for Africa (CfA)_Amharic ASR – Demo 🎙️")
